...
enum PlaceData {
    ...
    static let all: [Place] = [
        // 直辖市
        Place(name: "北京", province: "北京", longitude: 116.41),
        Place(name: "天津", province: "天津", longitude: 117.2),
        Place(name: "上海", province: "上海", longitude: 121.47),
        Place(name: "重庆", province: "重庆", longitude: 106.55),

        // 河北
        Place(name: "石家庄", province: "河北", longitude: 114.51),
        Place(name: "唐山", province: "河北", longitude: 118.18),
        Place(name: "保定", province: "河北", longitude: 115.48),
        Place(name: "邯郸", province: "河北", longitude: 114.49),
        ...
        // 山西
        Place(name: "太原", province: "山西", longitude: 112.55),
        ...
        // 内蒙古
        Place(name: "呼和浩特", province: "内蒙古", longitude: 111.75),
        Place(name: "包头", province: "内蒙古", longitude: 109.84),
        Place(name: "鄂尔多斯", province: "内蒙古", longitude: 109.8),
        Place(name: "赤峰", province: "内蒙古", longitude: 118.9),

        // 辽宁
        Place(name: "沈阳", province: "辽宁", longitude: 123.43),
        Place(name: "大连", province: "辽宁", longitude: 121.6),
        Place(name: "鞍山", province: "辽宁", longitude: 122.99),
        Place(name: "锦州", province: "辽宁", longitude: 121.1),

        // 吉林
        Place(name: "长春", province: "吉林", longitude: 125.32),
        Place(name: "吉林", province: "吉林", longitude: 126.55),
        Place(name: "延吉", province: "吉林", longitude: 129.5),

        // 黑龙江
        Place(name: "哈尔滨", province: "黑龙江", longitude: 126.53),
        Place(name: "大庆", province: "黑龙江", longitude: 125.11),
        ...
        Place(name: "苏州", province: "江苏", longitude: 120.62),
        Place(name: "无锡", province: "江苏", longitude: 120.3),
        Place(name: "常州", province: "江苏", longitude: 119.95),
        Place(name: "徐州", province: "江苏", longitude: 117.18),
        Place(name: "南通", province: "江苏", longitude: 120.86),
        ...
        // 浙江
        Place(name: "杭州", province: "浙江", longitude: 120.15),
        Place(name: "宁波", province: "浙江", longitude: 121.55),
        ...
        // 安徽
        Place(name: "合肥", province: "安徽", longitude: 117.28),
        ...
        Place(name: "厦门", province: "福建", longitude: 118.09),
        ...
        // 江西
        Place(name: "南昌", province: "江西", longitude: 115.89),
        ...
        Place(name: "青岛", province: "山东", longitude: 120.38),
        Place(name: "烟台", province: "山东", longitude: 121.39),
        Place(name: "潍坊", province: "山东", longitude: 119.1),
        ...
        // 河南
        Place(name: "郑州", province: "河南", longitude: 113.62),
        Place(name: "洛阳", province: "河南", longitude: 112.45),
        Place(name: "南阳", province: "河南", longitude: 112.5),
        Place(name: "新乡", province: "河南", longitude: 113.9),
        Place(name: "开封", province: "河南", longitude: 114.31),
        ...
        // 湖北
        Place(name: "武汉", province: "湖北", longitude: 114.31),
        ...
        // 湖南
        Place(name: "长沙", province: "湖南", longitude: 112.94),
        ...
        Place(name: "衡阳", province: "湖南", longitude: 112.57),
        Place(name: "常德", province: "湖南", longitude: 111.7),

        // 广东
        Place(name: "广州", province: "广东", longitude: 113.26),
        Place(name: "深圳", province: "广东", longitude: 114.06),
        Place(name: "佛山", province: "广东", longitude: 113.12),
        Place(name: "东莞", province: "广东", longitude: 113.75),
        Place(name: "珠海", province: "广东", longitude: 113.55),
        Place(name: "汕头", province: "广东", longitude: 116.68),
        Place(name: "惠州", province: "广东", longitude: 114.4),
        Place(name: "中山", province: "广东", longitude: 113.39),
        Place(name: "江门", province: "广东", longitude: 113.1),
        Place(name: "湛江", province: "广东", longitude: 110.36),
        Place(name: "茂名", province: "广东", longitude: 110.9),

        // 广西
        Place(name: "南宁", province: "广西", longitude: 108.37),
        Place(name: "柳州", province: "广西", longitude: 109.42),
        Place(name: "桂林", province: "广西", longitude: 110.29),
        Place(name: "北海", province: "广西", longitude: 109.1),
        Place(name: "玉林", province: "广西", longitude: 110.2),

        // 海南
        Place(name: "海口", province: "海南", longitude: 110.2),
        Place(name: "三亚", province: "海南", longitude: 109.51),

        // 四川
        Place(name: "成都", province: "四川", longitude: 104.07),
        ...
        // 贵州
        Place(name: "贵阳", province: "贵州", longitude: 106.63),
        Place(name: "遵义", province: "贵州", longitude: 106.93),
        Place(name: "六盘水", province: "贵州", longitude: 104.8),
        Place(name: "毕节", province: "贵州", longitude: 105.3),

        // 云南
        Place(name: "昆明", province: "云南", longitude: 102.83),
        Place(name: "大理", province: "云南", longitude: 100.23),
        Place(name: "丽江", province: "云南", longitude: 100.23),
        Place(name: "曲靖", province: "云南", longitude: 103.8),
        Place(name: "玉溪", province: "云南", longitude: 102.5),

        // 西藏
        Place(name: "拉萨", province: "西藏", longitude: 91.11),

        // 陕西
        Place(name: "西安", province: "陕西", longitude: 108.94),
        ...
        // 甘肃
        Place(name: "兰州", province: "甘肃", longitude: 103.83),
        Place(name: "天水", province: "甘肃", longitude: 105.7),
        Place(name: "酒泉", province: "甘肃", longitude: 98.5),

        // 青海
        Place(name: "西宁", province: "青海", longitude: 101.78),

        // 宁夏
        Place(name: "银川", province: "宁夏", longitude: 106.23),

        // 新疆
        Place(name: "乌鲁木齐", province: "新疆", longitude: 87.62),
        Place(name: "喀什", province: "新疆", longitude: 75.9),
        Place(name: "伊犁", province: "新疆", longitude: 81.3),

        // 港澳台
        Place(name: "香港", province: "香港", longitude: 114.17),
        ...
        Place(name: "灌阳", province: "广西", longitude: 111.15),
        Place(name: "资源", province: "广西", longitude: 110.64),
        Place(name: "永州", province: "湖南", longitude: 111.61),
        Place(name: "邵阳", province: "湖南", longitude: 111.47),
        Place(name: "郴州", province: "湖南", longitude: 113.02),
    ]
